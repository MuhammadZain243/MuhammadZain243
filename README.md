...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&duration=2500&pause=800&color=6C63FF&center=true&vCenter=true&random=false&width=700&lines=Crafting+Scalable+Web+Applications+%F0%9F%8C%90;Building+AI-Powered+Solutions+%F0%9F%A4%96;Designing+Clean+%26+Intuitive+UIs+%F0%9F%8E%A8;Exploring+ML+%26+Data+Analytics+%F0%9F%93%8A;Creating+Impactful+Solutions+%F0%9F%92%A1)](https://git.io/typing-svg)
...
timeline
    ...
    section 2023
        Pharmacy Management System : C# + MySQL
        Student Grade Tracker : Java/JSP + Jakarta EE
        DSA Mastery : Algorithms & Data Structures
    
    section 2024
        Data Analyst @ Mentorness : SQL + Power BI (Jun-Jul)
        Full-Stack Dev @ ISOLERA : React + Flask + AI (Jul-Oct)
        Started FYP - Handspeak : TensorFlow + Flutter
    
    section 2025
        MERN Stack Dev @ DeveloperTag : MongoDB + Express + React + Node (Jun-Present)
...
[![Get Quote](https://img.shields.io/badge/💬_GET_FREE_QUOTE-0A66C2?style=for-the-badge&logoColor=white)](mailto:zainm2432003@gmail.com)
